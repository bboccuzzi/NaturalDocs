/* 
 * Class: CodeClear.NaturalDocs.Engine.Languages.Parsers.Verilog
 * ____________________________________________________________________________
 * 
 * Additional language support for Verilog.
...
namespace CodeClear.NaturalDocs.Engine.Languages.Parsers
	...
	public class Verilog : Language
		...
		/* Constructor: Verilog
		 */
		public Verilog (Languages.Manager manager) : base (manager, "Verilog")
			{
			}
		...
		override public void SyntaxHighlight (Tokenizer source)
			...
			while (iterator.IsInBounds)
				...
				if (TryToSkipComment(ref iterator, ParseMode.SyntaxHighlight) ||
					...
					if (verilog1995keywords.Contains(identifier))
