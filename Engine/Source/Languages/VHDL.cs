/* 
 * Class: CodeClear.NaturalDocs.Engine.Languages.Parsers.VHDL
 * ____________________________________________________________________________
 * 
 * Additional language support for VHDL.
 * 
 */
...
namespace CodeClear.NaturalDocs.Engine.Languages.Parsers
	...
	public class VHDL : Language
		...
		/* Constructor: VHDL
		 */
		public VHDL (Languages.Manager manager) : base (manager, "VHDL")
			{
			}
