	...
	public class Topic
		...
		public bool DefinesClass
			...
			get
				...
				return ((commentType.Flags.ClassHierarchy || commentType.Flags.DatabaseHierarchy || commentType.Flags.InterfaceHierarchy || commentType.Flags.ModuleHierarchy) && isList == false);
				}
			}
